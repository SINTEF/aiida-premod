...
Check version number in setup.json and aiida_premod/__init__.py and make sure
they match.
"""
...
import aiida_premod  # pylint: disable=wrong-import-position
version = aiida_premod.__version__
